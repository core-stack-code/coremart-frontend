...
export const CUSTOM_ICON_MAP = {
    ...
    headerwhislistwithoutopenIcon: HeaderWhisListWithoutOpenIcon,
    headerwhislistwithopenIcon: HeaderWhisListWithOpenIcon,
    paymentdiscountIcon: PaymentDiscountIcon,
