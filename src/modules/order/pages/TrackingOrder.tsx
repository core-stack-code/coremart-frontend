        ...
        <div className="w-[90%] md:w-[85%] flex flex-col gap-8 mx-auto my-9">
            ...
            <div className="flex flex-col lg:flex-row gap-10">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-8">
                    ...
                    <div className="bg-surface p-3 rounded-rad space-y-2">
                        <p className="text-[16px] md:text-[18px] text-muted">Order ID</p>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between gap-4 sm:gap-0">
                        <div className="space-y-2">
                            <p className="text-[16px] md:text-[18px] text-muted">Ordered Date</p>
                    ...
                    <div className="flex flex-col gap-4">
                        <p className="text-muted text-lg md:text-2xl">Ordered Item</p>
