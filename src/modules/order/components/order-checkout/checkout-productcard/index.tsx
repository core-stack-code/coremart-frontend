...
const CheckoutProductCard: React.FC<CheckoutProductCardProps> = ({ checkoutCard }) => {
    return (
        <>
            <div className="w-full flex justify-between rounded-2xl border-border gap-2 border p-3">
                <div className="flex justify-between gap-2 p-2 h-50">
                    <div className="rounded-2xl items-center">
                        <img
                            ...
                            alt='image'
                            className="h-full w-62 rounded-2xl object-cover"
                        />
                    </div>
                    <div className="w-full">
                        <div className='flex flex-col gap-3'>
                            <div className="flex flex-col gap-2 text-muted">
                                ...
                                <p className="text-primary font-bold">Total : ₹2500</p>
                            </div>
                        </div>
                    </div>
                </div>
