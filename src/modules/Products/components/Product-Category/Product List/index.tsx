        ...
        <div className="w-full flex flex-col justify-around ">
          <div className='mx-10'>
            ...
            <div className="flex justify-start gap-4">
              <span className="text-lg font-bold text-[#9333EA]">₹ {product.price}</span>
              <Button className="flex items-center gap-2 border border-purple-500 text-purple-600 text-xs px-3 py-1 rounded-full hover:bg-purple-50 transition" onClick={getDetails}>
