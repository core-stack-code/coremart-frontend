...
import { personalInfoDefaultValues } from '@/modules/me/schemas/defaultValues'
import { personalInfoSchema, type personalInfoPayload } from '@/modules/me/schemas/meSchemas'
...
const PersonalInfo = () => {
    ...
    return (
        <div className="px-4 sm:px-6 lg:px-8 py-6 border border-border rounded-[var(--border-radius)]">
                            ...
                            <div className="space-y-4 text-center">
                                ...
                                {personalInfoEdit && (
                                    <NavLink to={"/user/profile"}>
                                        <p className="text-xs sm:text-xs text-primary">
                        ...
                        <div className="w-full flex flex-col gap-6 justify-center">
                                        ...
                                        <Controller
                                            ...
                                            render={({ field, fieldState }) => (
                                                <InputComponent
                                                    ...
                                                    wrapperClassName="bg-surface border-border"
                                                />
                                            )}
                                        />
                                    ) : (
                                    ...
                                    <Controller
                                        ...
                                        render={({ field, fieldState }) => (
                                            <InputComponent
                                                ...
                                                error={fieldState.error?.message}
                                                wrapperClassName="w-fit bg-surface border-border"
                                            />
                                        )}
                                    />
                                ) : (
                            ...
                            {personalInfoEdit && (
                                <div className="flex gap-5">
                                    ...
                                    <Button
                                        type="button"
                                        className="bg-background text-primary border border-primary hover:bg-primary/5"
